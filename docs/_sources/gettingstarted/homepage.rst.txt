...
create a View class for our Home page template and name it **Home.php**:
...
Now you are ready to visit you first SlaxWeb App for the first time by visiting
*http://myslaxwebapp.com*.

To explain a bit what is happening here, we are using the *loadView* service and
...
already printing out in the **Home.php** Template file.
