...
.. NOTE::
   This section is somewhat outdated and may be documented differently elsewhere
   already, but you should still read it to successfully complete the *Getting started*
   guide.
...
Follow the on-screen instructions and once again, but here, you are required to
install a *sub-component*. In this guide we will use the basic *database-pdo sub-component*.
